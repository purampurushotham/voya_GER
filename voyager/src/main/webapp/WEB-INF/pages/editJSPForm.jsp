...
        <form:form action="saveTourist" method="post" commandName="tourist">
    ...
    <div class="md-form">
        ...
        <input class="date" type="date" name="passport.expiredDate" data-date="" data-date-format="YYYY-MM-DD" value="2015-08-09" class="form-control" /><br>                   <%--<form:input path="passport.expiredDate" type="date" /><br>--%>
