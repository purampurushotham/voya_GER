...
<div align="center">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="md-form">
                <input type="text" id="searchTourist" class="form-control" />
                <label for="searchTourist">Search By any filter</label>
            </div>
            <div class="text-center mt-4" id="searchBtn">
    ...
    <table border="1" class="table table-hover table-responsive-md btn-table">
        ...
                        <tr onclick="window.location.href='/viewTourist?id=${tourist.id}'">
         
...
<script>
    $(document).ready(function () {
        $("#searchBtn").click(function () {
            var name  = $("#searchTourist").val();
            window.location.href = "/searchTourist?name="+name;
